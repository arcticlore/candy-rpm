...
Version:        3.1.2
Release:        1%{?dist}
Summary:        Анализ дерева каталогов с размерами
...
%description
Анализ дерева каталогов с размерами
...
%prep
%autosetup -N -a1 -n erdtree-3.1.2
%cargo_prep -v vendor
...
%changelog
* Sun Aug 30 2026 candy-bot <candy@localhost> - 3.1.2-1
